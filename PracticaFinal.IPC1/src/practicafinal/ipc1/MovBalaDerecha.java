...
public class MovBalaDerecha extends TimerTask {
    ...
    public void valores(int i, int j, int casillas, JLabel[][] mapa, Icon bala, int[][] ocupado, Icon torreta, int[][] enemigos, JLabel enemigo1, JLabel enemigo2, JLabel enemigo3, JLabel enemigo4){
        this.i = i;
        this.j = j;
